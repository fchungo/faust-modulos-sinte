...
x_vco_gate = ((x_vco_freq + x_vco_modf)>0) : ef.gate_mono(-60, 0.001, 0.05, 0.02); // Parámetro gate (on - off)
...
signal= out_sine, out_sawtooth, out_sawtooth_inv, out_triangle, out_square: selectn(5, x_vco_shape) : ba.bypass1(x_vco_gate, _);
